...
class Settings(BaseSettings):
    ...
    MONGODB_DB_NAME: str = Field(default="document_chat", description="MongoDB database name")
    MONGODB_MAX_CONNECTIONS: int = Field(default=100, description="Maximum MongoDB connections")
    MONGODB_TIMEOUT_MS: int = Field(default=100, description="Maximum MongoDB connections")
